        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-8">
                    ...
                    <p>على مدى ال 15 سنة الفائتة, استمرت شركة Arte Kids للملابس الجاهزة بامداد الأسواق بمنتجات عالية
                        الجودة, تطورت منتجات الشركة خلال الفترة السباقة لتشمل جميع احتياجات الأطفال من عمر 6 أشهر و حتى
                        16 سنة</p>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p>اضافة الى تجربة التسوق أونلاين المييزة التي نقدمها, نتشرف بزيارتكم لأقرب منفذ بيع في العناوين
                        التالية</p>
                </div>
            </div>
            <div class="row mb-4">
