        ...
        <div class="container">
            <div class="row about-company-section mb-5">
                ...
                <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                    <img src="{{url('public')}}/images/pwa-logo/icon-192x192.png" class="img-circle d-block mx-auto"
                        alt="Arte Logo" title="شعار شركة Arte" />
                </div>
            </div>
            <div class="branches-list-container">
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <p>اضافة الى تجربة التسوق أونلاين المميزة التي نقدمها, نتشرف بزيارتكم لأقرب منفذ بيع في العناوين
                            التالية</p>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                        ...
                        <ul class="branch-info-list">
                            ...
                            <li><i class="fas fa-phone"></i> <a dir="ltr" href="tel:00201027099000">0102 7099 000</a>
                            </li>
                            <li><i class="fas fa-phone"></i> <a dir="ltr" href="tel:00201061555638">0106 1555 638</a>
                            </li>
                        </ul>
                        <iframe
                    ...
                    <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                        ...
                        <ul class="branch-info-list">
                            ...
                            <li><i class="fas fa-phone"></i> <a dir="ltr" href="tel:00201122332200">0112 233 2200</a>
                            </li>
                        </ul>
                        <iframe
                ...
                <div class="row mb-5">
                    <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                        ...
                        <ul class="branch-info-list">
                            ...
                            <li><i class="fas fa-phone"></i> <a dir="ltr" href="tel:00201222688889">0122 2688 889</a>
                            </li>
                        </ul>
                        <iframe
                    ...
                    <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                        ...
                        <ul class="branch-info-list">
                            ...
                            <li><i class="fas fa-phone"></i> <a dir="ltr" href="tel:00201114220033">0111 4220 033</a>
                            </li>
                        </ul>
                        <iframe
                    ...
                    <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                        ...
                        <ul class="branch-info-list">
                            ...
                            <li><i class="fas fa-phone"></i> <a dir="ltr" href="tel:00201144986866">0114 4986 866</a>
                            </li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p>تنتج شركة Arte Kids كم هائل من المنتجات سنوياً, و نقوم بتوزيع منتجاتنا على علامات تجارية متعددة
                        تتبع جميعاً للشركة الأم Arte Kids</p>
                </div>
